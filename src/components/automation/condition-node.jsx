...
export function ConditionNode({ data }) {
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <div
        className={`w-16 h-16 rotate-45 flex items-center justify-center relative shadow-md transition-all duration-300 ${
          data?.isSelected
            ? "border-2 border-yellow-600 shadow-lg ring-2 ring-yellow-300 ring-opacity-50"
            : data?.isExecuting
            ? "border-[3px] border-green-500 shadow-xl shadow-green-500/60 ring-4 ring-green-400/40 scale-110"
